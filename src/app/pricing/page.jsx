...
const Pricing = () => {
  ...
  useEffect(() => {
    ...
    // Configure PDF.js worker after component mounts
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-slate-800/40 backdrop-blur-sm p-6 rounded-2xl border border-slate-700/40 shadow-xl">
            <div className="text-center py-8">
              ...
              <p className="text-slate-400 mt-4">Loading PDF viewer...</p>
            </div>
          </div>
          ...
          {error && (
            <div className="text-center py-8">
              ...
              <p className="text-slate-500 text-sm mt-2">
                Make sure the PDF file exists at: /pdfs/pricing-version-1.0.pdf
              </p>
            </div>
          )}
            ...
            {!loading && !error && (
              <div className="w-full">
                <Page
                  ...
                  width={typeof window !== "undefined" ? Math.min(800, window.innerWidth * 0.8) : 800}
                />
